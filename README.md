# Proton-CLI-Toolkit
An easy way to get started with Proton VPN on Linux

# Setup
All you need is proton-cli installed on your machine
...
Finally if you wish to look more into proton's own code, here is [their official source code](https://github.com/ProtonVPN/proton-vpn-cli)
